...
public class DESUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String key = "k38d81C!@#dkro22232JAMDGIJGDSe48dk>KUY%%$";
        String data = "workNo=test&groupName=普通用户&dateStr=2016-02-29&appVersion=&sysVersion=&endVersion=";        
        String encryptData1 = encrypt(data, key);
        System.out.println("加密后: " + encryptData1);
        System.out.println();
        System.out.println("加密后: " + URLEncoder.encode(encryptData1, "UTF-8"));
        String decryptData1 = decrypt(encryptData1, key);
